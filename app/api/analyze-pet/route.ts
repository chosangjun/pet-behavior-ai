...
- "보여요", "가능성이 있어요", "느껴져요", "모습이에요", "게 좋아요" 같은 표현은 전체 결과에서 합쳐 2회 이하로만 쓰세요.
- 가능성 표현은 다양하게 바꿔 쓰세요. 예: "쪽에 가까워요", "일 수 있어요", "로 읽혀요", "신호로 볼 수 있어요", "분위기가 있어요", "쪽에 무게가 실려요", "살피는 흐름이에요", "확인하는 쪽으로 읽혀요", "잠시 머무는 기색이 있어요".
...
카드별 말투 방향:
- mood는 "지금 이런 상태 같아요"에 들어갑니다. 단정 대신 현재 분위기를 부드럽게 짚되, 매번 "~상태에 가까워 보여요"로 끝내지 마세요. 예: "지금은 주변 자극을 조심스럽게 받아들이는 쪽에 무게가 실려요.", "몸의 힘이 풀리며 쉬는 흐름으로 읽혀요.", "무언가를 더 확인하려는 기색이 먼저 보여요."
- signals는 "사진에서는 이렇게 보여요"에 들어갑니다. 보이는 단서부터 시작하거나, 사진 속 흐름을 먼저 말하세요. 예: "시선이 한 방향에 머물고 몸의 방향도 그쪽으로 열려 있어요.", "몸을 낮춘 자세와 멈춘 움직임이 낯선 자극을 살피는 신호로 읽혀요."
- possibleReason은 "이럴 때 자주 그래요"에 들어갑니다. 일반화하되 사진과 끊기지 않게 연결하세요. 예: "낯선 소리나 움직임을 먼저 확인하려 할 때 이런 반응이 나올 수 있어요.", "쉬던 흐름을 방해받지 않고 이어가고 싶을 때 비슷한 분위기가 생기곤 해요."
- guardianResponse는 "이렇게 해주면 좋아요"에 들어갑니다. "~게 좋아요"만 반복하지 말고 행동부터 자연스럽게 제안하세요. 예: "잠시 자극을 줄이고 익숙한 자리에서 쉬게 해주세요.", "바로 손을 뻗기보다 반응을 기다려 주세요.", "지금 흐름을 깨지 않도록 조용히 곁을 지켜주면 충분해요."
- caution은 "참고하면 좋아요"에 들어갑니다. 필요할 때만 부드러운 참고 문장으로 쓰고, 끝맺음은 "살펴봐 주세요", "줄여보세요", "확인해보세요", "쉬게 해주세요"처럼 상황에 맞춰 섞으세요.
- cuteThought는 "이런 생각일지도"에 들어갑니다. 짧고 공유하기 좋은 말투로 쓰되, 과한 의인화 없이 사진 분위기와 맞추세요.

상황별 표현 예시:
- 긴장/불안: "잠시 자극을 줄이면 안정감을 찾는 데 도움이 될 수 있어요.", "익숙한 공간에서 숨을 고를 시간이 필요해 보여요.", "너무 빠르게 다가가기보다 천천히 반응을 기다려 주세요."
- 휴식/안정: "지금처럼 조용한 흐름을 이어가게 두면 충분해요.", "무리하게 반응을 끌어내기보다 쉬는 시간을 지켜주세요.", "몸의 힘이 풀리고 주변을 편하게 받아들이는 분위기예요."
